...
//     try {
//       // const buscarUsuario = await PersonaTbl.findOne({where:{Email:email}});
//       // Busca un usuario por email
//       const [user, created] = await PersonaTbl.findOrCreate({
//         where: { email: email },
//         defaults: registrarUsuario,
//       });
//       console.log(user, "primer usuario")
//       // Si el usuario ya existía, actualiza sus datos
//       if (!created) {
//         console.log("El usuario ya existia y se actualizo");
//         await PersonaTbl.update(registrarUsuario, {
//           where: { email: email },
//         });
//       }

//       //Envio al front info usuario
//       const buscarUsuario = await PersonaTbl.findOne({where:{Email:email}});

//       const { Nombre, DniCuit, Email, Domicilio, NroTel } = user;
